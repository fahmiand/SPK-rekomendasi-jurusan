...
!(function (t, e) {
	"object" == typeof exports && "undefined" != typeof module
		...
		? define(e)
		: ((t = "undefined" != typeof globalThis ? globalThis : t || self).Trix =
				e());
})(this, function () {
	"use strict";
	var t = "2.0.0";
	...
	const c = "\ufeff",
		...
		p = function (t) {
			...
			return (
				s.initEvent(t, i, n), null != r && h.call(s, r), o.dispatchEvent(s)
			);
		},
		f = function (t, e) {
					...
					return (() => {
						...
						return (
							Array.from(t).forEach((t) => {
								...
								t > 65535 &&
									((t -= 65536),
									(i += String.fromCharCode(((t >>> 10) & 1023) | 55296)),
									(t = 56320 | (1023 & t))),
	...
	const ht = () => (at || (at = pt().concat(gt())), at),
		...
		yt = function (t) {
			...
			{
				const { body: t } = new DOMParser().parseFromString(i, "text/html");
	...
	class Ft extends V {
		...
		update() {
			...
			if (!Bt(t, this.domRange))
				return (
					(this.domRange = t), this.notifySelectionManagersOfSelectionChange()
				);
		}
		reset() {
	...
	const Bt = (t, e) =>
			...
			(null == t ? void 0 : t.endOffset) === (null == e ? void 0 : e.endOffset),
		Pt = new Ft(),
		It = function () {
				...
				Array.from(e).forEach((e) => {
					...
					if (t) {
						...
						if (
							...
							void 0 !== s &&
							s.call(e, i) &&
							null !== (a = (l = t[t.length - 1]).canBeGroupedWith) &&
							void 0 !== a &&
							a.call(l, e, i)
						)
					...
					null !== (o = e.canBeGrouped) && void 0 !== o && o.call(e, i)
						? (t = [e])
						: r.push(e);
				}),
	...
	class ee extends V {
		...
		invalidate() {
			...
			return (
				(this.nodes = null),
				(this.childViews = []),
				null === (t = this.parentView) || void 0 === t ? void 0 : t.invalidate()
			);
		}
	...
	class re extends ee {
		...
		createCaptionElement() {
			const t = S({ tagName: "figcaption", className: ne.attachmentCaption }),
		...
		getClassName() {
			const t = [
					ne.attachment,
					"".concat(ne.attachment, "--").concat(this.attachment.getType()),
				],
	...
	class ae extends re {
		...
		createCaptionElement() {
			...
			return (
				t.textContent ||
					t.setAttribute("data-trix-placeholder", s.captionPlaceholder),
				t
			);
		}
		refresh(t) {
	...
	class de extends ee {
		...
		createNodes() {
			...
			if (this.block.isEmpty()) t.push(S("br"));
				...
				var e;
				const i =
						null === (e = dt(this.block.getLastAttribute())) || void 0 === e
							? void 0
							: e.text,
	...
	class ge extends ee {
		...
		render() {
			if (
				...
				const t = Xt.groupObjects(this.document.getBlocks(), { asTree: !0 });
				Array.from(t).forEach((t) => {
	...
	class Ce extends it {
		...
		getExtension() {
			var t;
			return null === (t = this.getFilename().match(/\.(\w+)$/)) || void 0 === t
				? void 0
				: t[1].toLowerCase();
		}
		getContentType() {
			...
			return (
				0 === t
					...
					: ((e = new this.constructor(
					  ...
					  (i = new this.constructor(this.string.slice(t), this.attributes))),
				[e, i]
			);
		}
		toConsole() {
	...
	class Ee extends it {
		...
		splitObjectsAtRange(t) {
			...
			return (
				([i, e] = new this.constructor(i).splitObjectAtPosition(De(t) + r)),
				[i, n, e - 1]
			);
		}
		...
		splitObjectAtPosition(t) {
			let e, i;
			const { index: n, offset: r } = this.findIndexAndOffsetAtPosition(t),
	...
	class we extends it {
		...
		getAttributesAtPosition(t) {
			var e;
			return (
				(null === (e = this.pieceList.getObjectAtPosition(t)) || void 0 === e
					? void 0
					: e.getAttributes()) || {}
			);
		}
		...
		getAttachmentAndPositionById(t) {
			...
			for (const n of this.pieceList.toArray()) {
				var i;
				if ((null === (i = n.attachment) || void 0 === i ? void 0 : i.id) === t)
	...
	class qe extends it {
		...
		insertDocumentAtRange(t, e) {
			...
			return (
				Lt(e) && a.isEmpty() && !a.hasAttributes()
					? (s = new this.constructor(s.blockList.removeObjectAtIndex(r)))
					: a.getBlockBreakPosition() === o && n++,
				(s = s.removeTextAtRange(e)),
				new this.constructor(s.blockList.insertSplittableListAtPosition(i, n))
			);
		}
		...
		removeTextAtRange(t) {
			...
			if (
				...
				const i = l.text.getTextAtRange([0, a]),
					...
					r = i.appendText(n);
				t =
					s !== c && 0 === a && l.getAttributeLevel() >= h.getAttributeLevel()
						? h.copyWithText(r)
						: l.copyWithText(r);
				const o = c + 1 - s;
		...
		addAttribute(t, e) {
			...
			return (
				this.eachBlock(
					(n, r) => (i = i.editObjectAtIndex(r, () => n.addAttribute(t, e)))
				),
		...
		removeAttributeAtRange(t, e) {
			...
			return (
				this.eachBlockAtRange(e, function (e, n, r) {
					dt(t)
						? (i = i.editObjectAtIndex(r, () => e.removeAttribute(t)))
						: n[0] !== n[1] &&
						  (i = i.editObjectAtIndex(r, () =>
								e.copyWithText(e.text.removeAttributeAtRange(t, n))
						  ));
				}),
				new this.constructor(i)
			);
		...
		removeBlockAttributesAtRange(t) {
			...
			return (
				this.eachBlockAtRange(t, function (t, i, n) {
					t.hasAttributes() &&
						(e = e.editObjectAtIndex(n, () => t.copyWithoutAttributes()));
				}),
				new this.constructor(e)
			);
		}
		expandRangeToLineBreaksAndSplitBlocks(t) {
			...
			if (
				...
				(o.index -= 1),
					(o.offset = s.getBlockAtIndex(o.index).getBlockBreakPosition());
			else {
			...
			if (Lt(t)) return this.getCommonAttributesAtPosition(e);
			{
				...
				return (
					this.eachBlockAtRange(t, function (t, n) {
						if (n[0] !== n[1])
							return (
								e.push(t.text.getCommonAttributesAtRange(n)), i.push(Ue(t))
							);
					}),
					_t
		...
		getRangeOfCommonAttributeAtPosition(t, e) {
			const { index: i, offset: n } = this.locationFromPosition(e),
				...
				[o, s] = Array.from(r.getExpandedRangeForAttributeAtOffset(t, n)),
		...
		findRangesForTextAttribute(t) {
			...
			return (
				this.getPieces().forEach((o) => {
					...
					})(o) && (n[1] === i ? (n[1] = i + s) : r.push((n = [i, i + s]))),
						(i += s);
				}),
				r
			);
		...
		locationFromPosition(t) {
			...
			if (null != e.index) return e;
			{
				...
				return { index: t.length - 1, offset: t[t.length - 1].getLength() };
			}
		}
	...
	class $e extends V {
		...
		appendBlockForTextNode(t) {
			...
			if (e === this.containerElement || this.isBlockElement(e)) {
				...
				nt(
					...
					((this.currentBlock = this.appendBlockForAttributesWithElement(t, e)),
			...
			switch (R(t)) {
				...
				case "tr":
					if (this.needsTableSeparator(t))
						return this.appendStringWithAttributes(M.tableRowSeparator);
					break;
				case "td":
					if (this.needsTableSeparator(t))
						return this.appendStringWithAttributes(M.tableCellSeparator);
			}
		}
		...
		getTextAttributes(t) {
			...
			for (const n in j) {
				...
				if (
					...
					r.styleProperty && ((e = t.style[r.styleProperty]), e && (i[n] = e));
			}
			if (P(t)) {
		...
		getBlockAttributes(t) {
			...
			for (; t && t !== this.containerElement; ) {
				for (const r in n) {
					...
					if (!1 !== o.parse)
						if (R(t) === o.tagName)
							((null !== (i = o.test) && void 0 !== i && i.call(o, t)) ||
								!o.test) &&
		...
		isBlockElement(t) {
			if (
				...
				!P(t) &&
				!b(t, { matchingSelector: "td", untilNode: this.containerElement })
			)
				return (
					k().includes(R(t)) || "block" === window.getComputedStyle(t).display
				);
		}
		...
		translateBlockElementMarginsToNewlines() {
			...
			for (let e = 0; e < this.blocks.length; e++) {
				...
				i &&
					(i.top > 2 * t.top && this.prependStringToTextAtIndex("\n", e),
					i.bottom > 2 * t.bottom && this.appendStringToTextAtIndex("\n", e));
			}
		}
	...
	const Xe = function (t) {
		...
		ai = {
			...
			"text/html": function (t) {
				...
				return (
					Array.from(e.querySelectorAll("[data-trix-serialize=false]")).forEach(
						(t) => {
							y(t);
						}
					),
		...
		requestRemovalOfAttachment(t) {
			...
			if (this.attachmentIsManaged(t))
				return null === (e = this.delegate) ||
					void 0 === e ||
					null === (i = e.attachmentManagerDidRequestRemovalOfAttachment) ||
					void 0 === i
					? void 0
					: i.call(e, t);
		}
	...
	class di extends V {
		...
		insertText(t) {
			...
			const n = i[0],
				r = n + t.getLength();
			return (
				e && this.setSelection(r), this.notifyDelegateOfInsertionAtRange([n, r])
			);
		}
		insertBlock() {
			let t =
		...
		insertDocument() {
			...
			const i = e[0],
				n = i + t.getLength();
			return (
				this.setSelection(n), this.notifyDelegateOfInsertionAtRange([i, n])
			);
		}
		insertString(t, e) {
		...
		removeLastBlockAttribute() {
			...
			return (
				this.removeCurrentAttribute(i.getLastAttribute()), this.setSelection(t)
			);
		}
		insertPlaceholder() {
			return (
		...
		positionIsBlockBreak(t) {
			var e;
			return null === (e = this.document.getPieceAtPosition(t)) || void 0 === e
				? void 0
				: e.isBlockBreak();
		}
		getSelectedDocument() {
						...
						Array.from(e).forEach((e) => {
							...
							(e.delegate = this),
								t.push(
									null === (i = this.delegate) ||
										void 0 === i ||
										null === (n = i.compositionDidAddAttachment) ||
										void 0 === n
										? void 0
										: n.call(i, e)
								);
		...
		breakFormattedBlock(t) {
			...
			return (
				this.setDocument(e.insertDocumentAtRange(o, r)), this.setSelection(n)
			);
		}
		getPreviousBlock() {
			const t = this.getLocationRange();
	...
	class fi {
		...
		removeBlockAttribute() {
			return this.findRangesOfBlocks().map(
				(t) => (this.document = this.document.removeAttributeAtRange(pi, t))
			);
		}
		applyBlockAttribute() {
			let t = 0;
	...
	class Ai {
		...
		loadHTML() {
			let t =
				arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
			const e = $e.parse(t, { referenceElement: this.element }).getDocument();
	...
	class Ei {
		createDOMRangeFromPoint(t) {
			...
			if (document.caretPositionFromPoint) {
				const { offsetNode: t, offset: r } = document.caretPositionFromPoint(
					i,
					n
				);
	...
	class ki extends V {
		...
		selectionIsCollapsed() {
			var t;
			return (
				!0 === (null === (t = Nt()) || void 0 === t ? void 0 : t.collapsed)
			);
		}
		selectionIsExpanded() {
		...
		updateCurrentLocationRange(t) {
			var e, i;
			if (
				(null != t ? t : (t = this.createLocationRangeFromDOMRange(Nt()))) &&
		...
		domRangeWithinElement(t) {
			return t.collapsed
				...
				: A(this.element, t.startContainer) && A(this.element, t.endContainer);
		}
	}
				...
				Ae(
					...
					Bi(() => {
						...
						return (
							...
							m("click", { onElement: t, withCallback: this.didClickToolbar }),
							m("click", {
								onElement: t,
							...
							p("trix-attachment-before-toolbar", {
								onElement: this.element,
								attributes: { toolbar: t, attachment: this.attachment },
							}),
							{ do: () => this.element.appendChild(t), undo: () => y(t) }
						);
					})
				),
				Ae(
					...
					Bi(() => {
						...
						m("input", { onElement: t, withCallback: i }),
							m("input", { onElement: t, withCallback: this.didInputCaption }),
							m("keydown", {
								onElement: t,
							...
							m("blur", { onElement: t, withCallback: this.didBlurCaption });
						...
						return {
							do: () => {
								if (
									...
									r.appendChild(t),
									r.appendChild(e),
									r.classList.add("".concat(Ti.attachmentCaption, "--editing")),
		...
		didKeyDownCaption(t) {
			...
			if ("return" === Fi[t.keyCode])
				return (
					...
					null === (e = this.delegate) ||
					void 0 === e ||
					null === (i = e.attachmentEditorDidRequestDeselectingAttachment) ||
					void 0 === i
						? void 0
	...
	class Ii extends V {
		constructor(t, i) {
			super(...arguments),
				...
				m("focus", { onElement: this.element, withCallback: this.didFocus }),
				m("blur", { onElement: this.element, withCallback: this.didBlur }),
				m("click", {
					onElement: this.element,
		...
		render() {
			...
			this.canSyncDocumentView() && !this.documentView.isSynced()) &&
				(null === (i = this.delegate) ||
					void 0 === i ||
					null === (n = i.compositionControllerWillSyncDocumentView) ||
					void 0 === n ||
					n.call(i),
		...
		attachmentEditorDidRequestUpdatingAttributesForAttachment(t, e) {
			...
			return (
				null === (i = this.delegate) ||
					void 0 === i ||
					null === (n = i.compositionControllerWillUpdateAttachment) ||
					void 0 === n ||
					n.call(i, e),
		...
		attachmentEditorDidRequestRemovalOfAttachment(t) {
			...
			return null === (e = this.delegate) ||
				void 0 === e ||
				null === (i = e.compositionControllerDidRequestRemovalOfAttachment) ||
				void 0 === i
				? void 0
				: i.call(e, t);
		}
		attachmentEditorDidRequestDeselectingAttachment(t) {
			...
			return null === (e = this.delegate) ||
				void 0 === e ||
				null === (i = e.compositionControllerDidRequestDeselectingAttachment) ||
				void 0 === i
				? void 0
				: i.call(e, t);
		}
	...
	class Vi extends V {
		constructor(t) {
			...
			for (const t in this.constructor.events)
				m(t, { onElement: this.element, withCallback: this.handlerFor(t) });
		}
		elementDidMutate(t) {}
			...
			return Promise.all(e).then((t) => {
				this.handleInput(function () {
					...
					return (
						...
						null === (i = this.responder) || void 0 === i || i.insertFiles(t),
						this.requestRender()
					);
				});
			});
	...
	Ae(Ki, "events", {
		keydown(t) {
			...
			if (e) {
				...
				["ctrl", "alt", "shift", "meta"].forEach((e) => {
					...
					null != (null === (i = n) || void 0 === i ? void 0 : i[e]) &&
		...
		keypress(t) {
			...
			return e
				? (null === (i = this.delegate) ||
				  ...
				  null === (n = this.responder) || void 0 === n || n.insertString(e),
			...
			if (this.draggedRange || this.canAcceptDataTransfer(t.dataTransfer)) {
				...
				if (!Et(n, this.draggingPoint))
					return (
						...
						null === (e = this.delegate) ||
						void 0 === e ||
						null === (i = e.inputControllerDidReceiveDragOverPoint) ||
						void 0 === i
							? void 0
		...
		drop(t) {
			...
			t.preventDefault();
			const n =
					null === (e = t.dataTransfer) || void 0 === e ? void 0 : e.files,
			...
			if (
				...
				null === (l = this.responder) || void 0 === l || l.insertDocument(t),
					this.requestRender();
			}
		...
		paste(t) {
			...
			if (n) {
				...
				(i.type = "text/html"),
					...
					null === (a = this.responder) || void 0 === a || a.insertHTML(i.html),
					this.requestRender(),
				...
				(i.type = "text/html"),
					...
					null === (g = this.responder) || void 0 === g || g.insertHTML(i.html),
					this.requestRender(),
				...
				if (t) {
					var v, A, x;
					const e = Gi(t);
					!t.name && e && (t.name = "pasted-file-".concat(++Ji, ".").concat(e)),
						(i.type = "File"),
						(i.file = t),
					  ...
					  this.canApplyToDocument()
							? (this.setInputSummary({ preferDocument: !0, didInput: !1 }),
							  ...
							  null === (r = this.responder) || void 0 === r
									? void 0
									: r.setSelectedRange(this.range[0] + this.data.end.length))
			...
			return (
				0 ===
					(null === (t = this.data.start) || void 0 === t
						? void 0
						: t.length) &&
				(null === (e = this.data.end) || void 0 === e ? void 0 : e.length) >
					0 &&
				this.range
			);
		}
	...
	class Zi extends Vi {
		...
		withTargetDOMRange(t, e) {
			var i;
			return (
				"function" == typeof t && ((e = t), (t = this.getTargetDOMRange())),
				t
					? null === (i = this.responder) || void 0 === i
						? void 0
	...
	Ae(Zi, "events", {
		...
		paste(t) {
			...
			return nn(t)
				...
				? (t.preventDefault(),
				  ...
				  null === (l = this.responder) || void 0 === l || l.insertHTML(i.html),
				  this.render(),
		...
		Ae(Zi, "inputTypes", {
			...
			formatRemove() {
				this.withTargetDOMRange(function () {
					for (const i in null === (t = this.responder) || void 0 === t
						? void 0
	...
	const tn = function (t) {
		...
		en = (t) => {
			var e;
			return Array.from(
				(null === (e = t.dataTransfer) || void 0 === e ? void 0 : e.types) || []
			).includes("Files");
		},
		nn = function (t) {
			const e = t.clipboardData;
	...
	class bn extends V {
		...
		didClickActionButton(t, e) {
			var i;
			null === (i = this.delegate) || void 0 === i || i.toolbarDidClickButton(),
				t.preventDefault();
			const n = pn(e);
	...
	class vn extends Ni {
		constructor(t) {
			...
			super(...arguments),
				...
				(this.attachmentManager = new ui(this.composition.getAttachments())),
				...
				(this.toolbarController = new bn(this.editorElement.toolbarElement)),
	...
	const Sn = function (t) {
		...
		Ln = function (t) {
			...
			if (
				...
				if (["div", "p"].includes(t))
					return document.execCommand("DefaultParagraphSeparator", !1, t);
			}
		},
